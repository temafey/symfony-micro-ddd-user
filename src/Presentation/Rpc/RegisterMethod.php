 ...
 */
class RegisterMethod implements JsonRpcMethodInterface, MethodWithValidatedParamsInterface, JsonRpcMethodWithDocInterface
{
    /**
     * CommandBus object.
     *
    ...
    public function apply(?array $paramList = null)
    {
        ...
        return $this->commandBus->handle($this->commandFactory->makeUserRegisterTaskCommand($userDto));
    }
