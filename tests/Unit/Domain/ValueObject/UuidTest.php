...
class UuidTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Uuid::fromNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UuidDataProvider::getDataForFromNativeMethod()
     *
     ...
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UuidDataProvider::getInvalidTypeErrorData()
     *
     * @param mixed[] $mockArgs
     *
     * @throws Exception
     ...
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::toNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UuidDataProvider::getInvalidNativeArgumentExceptionData()
     *
     * @param mixed[] $mockArgs
     *
     * @throws Exception
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Uuid::toNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UuidDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     *
     * @throws Exception
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Uuid::sameValueAs
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UuidDataProvider::getDataForSameValueAsMethod()
     *
     * @param mixed[] $mockArgs
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Uuid::isEmpty
     */
