...
class CreatedAtTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::fromNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForFromNativeMethod()
     *
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::toNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::fromNativeDateTime
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForFromNativeDateTimeMethod()
     *
     * @param mixed[] $mockArgs
     *
     * @throws InvalidDateException
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::now
     *
     * @throws InvalidDateException
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::sameValueAs
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForSameValueAsMethod()
     *
     * @param mixed[] $mockArgs
     *
     * @throws InvalidDateException
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::getDate
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForGetDateMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::getTime
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForGetTimeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\CreatedAt::toNativeDateTime
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\CreatedAtDataProvider::getDataForToNativeDateTimeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     *
