...
class UpdatedAtTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::fromNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForFromNativeMethod()
     *
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::toNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::fromNativeDateTime
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForFromNativeDateTimeMethod()
     *
     * @param mixed[] $mockArgs
     *
     * @throws InvalidDateException
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::now
     *
     * @throws InvalidDateException
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::sameValueAs
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForSameValueAsMethod()
     *
     * @param mixed[] $mockArgs
     *
     * @throws InvalidDateException
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::getDate
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForGetDateMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::getTime
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForGetTimeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\UpdatedAt::toNativeDateTime
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\UpdatedAtDataProvider::getDataForToNativeDateTimeMethod()
     *
     * @param mixed[] $mockArgs
     * @param mixed[] $mockTimes
     *
