...
class IdTest extends UnitTestCase
{
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::sameValueAs
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getDataForSameValueAsMethod()
     *
     ...
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getDataForToNativeMethod()
     *
     * @param mixed[] $mockArgs
     */
     ...
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::toNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getInvalidData()
     *
     * @param mixed[] $mockArgs
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::toReal
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getDataForToRealMethod()
     *
     * @param mixed[] $mockArgs
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::inc
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getDataForIncMethod()
     *
     * @param mixed[] $mockArgs
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::decr
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getDataForDecrMethod()
     *
     * @param mixed[] $mockArgs
     */
     ...
     * @group unit
     *
     * @covers       \Backend\Api\User\Domain\ValueObject\Id::fromNative
     *
     * @dataProvider \Backend\Api\User\Tests\Unit\DataProvider\Domain\ValueObject\IdDataProvider::getDataForFromNativeMethod()
     *
     * @param mixed[] $mockArgs
     */
