...
{
    /**
     * Return test data for Backend\Api\User\Domain\Factory\EventFactory.
     *
     * @return mixed[]
     */
    public function getDataForMakeUserWasRegisteredEventMethod(): array
    {
        return [
            0 => [
                0 => [
                    'makeUserWasRegisteredEvent' => null,
                    'UUID' => [
     ...
     * @return mixed[]
     */
    public function getDataForMakeUserWasUpdatedEventMethod(): array
    {
        return [
            0 => [
                0 => [
                    'makeUserWasUpdatedEvent' => '1989-11-13',
                    'UUID' => [
     ...
     * @return mixed[]
     */
    public function getDataForMakeUserWasDeletedEventMethod(): array
    {
        return [
            0 => [
                0 => [
                    'makeUserWasDeletedEvent' => null,
                    'UUID' => [
     ...
     * @return mixed[]
     */
    public function getDataForMakeUserIdWasCreatedEventMethod(): array
    {
        return [
            0 => [
                0 => [
                    'makeUserIdWasCreatedEvent' => null,
                    'UUID' => [
     ...
     * @return mixed[]
     */
    public function getDataForMakeUserIdWasAddedEventMethod(): array
    {
        return [
            0 => [
                0 => [
                    'makeUserIdWasAddedEvent' => null,
                    'UUID' => [
