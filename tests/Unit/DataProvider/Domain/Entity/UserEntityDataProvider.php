...
namespace Backend\Api\User\Tests\Unit\DataProvider\Domain\Entity;

/**
 * DataProvider for class {testClassName}.
 */
class UserEntityDataProvider
{
    /**
     * Return test data for Backend\Api\User\Domain\Entity\UserEntity.
     *
     * @return mixed[]
     */
