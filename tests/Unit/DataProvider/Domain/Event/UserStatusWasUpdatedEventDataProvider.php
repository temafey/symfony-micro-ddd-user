...
namespace Backend\Api\User\Tests\Unit\DataProvider\Domain\Event;

/**
 * DataProvider for class {testClassName}.
 */
class UserAgeWasUpdatedEventDataProvider
{
    /**
     * Return test data for Backend\Api\User\Domain\Event\UserAgeWasUpdatedEvent.
     *
     * @return mixed[]
     */
     ...
     * @return mixed[]
     */
    public function getDataWithInvalidAgeForDeserializeMethod(): array
    {
        return [
            0 => [
                0 => [
