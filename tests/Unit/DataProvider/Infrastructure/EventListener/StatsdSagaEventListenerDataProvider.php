...
namespace Backend\Api\User\Tests\Unit\DataProvider\Infrastructure\EventListener;
...
{
    /**
     * Return test data for Backend\Api\User\Infrastructure\EventListener\StatsdSagaEventListener.
     *
     * @return mixed[]
     */
            ...
            0 => [
                0 => [
                    ...
                    'setLogger' => [
                        ...
                        'className' => 'Backend\\\Api\\User\\Infrastructure\\EventListener\\StatsdSagaEventListener',
                    ],
                    'LoggerInterface' => [
                        'emergency' => null,
                        'alert' => null,
