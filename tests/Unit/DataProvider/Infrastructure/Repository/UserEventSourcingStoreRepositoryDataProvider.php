 ...
 */
class UserEventSourcingStoreRepositoryDataProvider
{
    /**
     * Return test data for Backend\Api\User\Infrastructure\Repository\UserEventSourcingStoreRepository.
     *
     * @return mixed[]
     */
            ...
            0 => [
                0 => [
                    ...
                    'UserEntity' => [
                        ...
                        'getPlayhead' => 3,
                        'className' => 'Backend\\\Api\\User\\Domain\\Entity\\UserEntity',
                    ],
                ],
                1 => [
                    'EventStore' => [
