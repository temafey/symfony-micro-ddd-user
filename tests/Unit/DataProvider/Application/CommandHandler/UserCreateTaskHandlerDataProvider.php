 ...
 */
class UserRegisterTaskHandlerDataProvider
{
    /**
    ...
    public function getDataForHandleMethod(): array
    {
        return [
            0 => [
                0 => [
                    'UserTaskRepositoryInterface' => [
                        'addCreateTask' => null,
                        'addUpdateTask' => '1980-09-07',
                        'addDeleteTask' => null,
                    ],
                    'UserRegisterTaskCommand' => [
                        'getUser' => [
                            'toArray' => [
                                0 => 'numquam',
                                1 => 'et',
                            ...
                            'setNickname' => 'https://reinger.com/consequuntur-in-rerum-architecto.html',
                            'getCreatedAt' => [
                                'toNative' => [
                ...
                0 => [
                    ...
                    'UserRegisterTaskCommand' => [
                        'getUser' => [
                            ...
                            'setNickname' => 'http://rolfson.com/delectus-architecto-rem-repellendus-qui-et-neque-est-vel',
                            'getCreatedAt' => [
                                'toNative' => [
                ...
                0 => [
                    ...
                    'UserRegisterTaskCommand' => [
                        'getUser' => [
                            ...
                            'setNickname' => 'http://labadie.com/possimus-debitis-alias-voluptatem-assumenda',
                            'getCreatedAt' => [
                                'toNative' => [
