...
namespace Backend\Api\User\Tests\Unit\DataProvider\Application\Saga;

/**
 * DataProvider for class {testClassName}.
 */
class UserSagaDataProvider
{
    /**
     * Return test data for Backend\Api\User\Application\Saga\UserSaga.
     *
     * @return mixed[]
     */
    public function getDataForConfigurationMethod(): array
    {
        return [
            0 => [
                0 => [
                    'configuration' => [
                        'UserIdWasCreatedEvent' => null,
                    ],
                ],
                1 => [
                    'configuration' => [
                        'times' => 0,
                        'UserIdWasCreatedEvent' => 0,
                    ],
                ],
            ],
        ];
     ...
     * @return mixed[]
     */
    public function getDataForHandleUserIdWasCreatedEventMethod(): array
    {
        return [
            0 => [
                0 => [
                    ...
                    'handleUserIdWasCreatedEvent' => null,
                    'State' => [
                        'set' => null,
                        'get' => null,
                        'getId' => 'nam',
