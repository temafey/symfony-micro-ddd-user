...
{
    /**
     * Return test data for Backend\Api\User\Domain\Query\FetchOneHandler.
     *
     * @return mixed[]
     */
                ...
                0 => [
                    ...
                    'UserAssembler' => [
                        'writeDto' => [
                            ...
                            'setPassword' => null,
                            'getNickname' => 'http://www.thiel.com/',
                            'setNickname' => 'http://www.schmeler.com/quos-dolor-sunt-nisi-esse-vitae-hic.html',
                            'getAge' => 9,
                            'setAge' => null,
                            'getCreatedAt' => 'fugit',
                            'setCreatedAt' => null,
                ...
                0 => [
                    ...
                    'UserAssembler' => [
                        'writeDto' => [
                            ...
                            'getPassword' => 4,
                            'setPassword' => null,
                            'getNickname' => 'http://www.prosacco.com/quis-qui-quas-impedit-reprehenderit-maiores',
                            'setNickname' => 'http://www.macejkovic.info/tempore-voluptatum-ut-aut-in-delectus-ab-sed',
                            'getAge' => 4,
                            'setAge' => null,
                ...
                0 => [
                    ...
                    'UserAssembler' => [
                        'writeDto' => [
                            ...
                            'setPassword' => null,
                            'getNickname' => 'http://moore.com/perspiciatis-aliquam-rerum-ut',
                            'setNickname' => 'http://www.barton.com/expedita-assumenda-nulla-nihil-aut-accusamus-ut-asperiores-qui.html',
                            'getAge' => 4,
                            'setAge' => null,
                            'getCreatedAt' => 'nemo',
                            'setCreatedAt' => null,
                ...
                0 => [
                    ...
                    'UserAssembler' => [
                        'writeDto' => [
                            ...
                            'getPassword' => 7,
                            'setPassword' => null,
                            'getNickname' => 'http://nitzsche.com/',
                            'setNickname' => 'http://nader.com/quis-similique-illum-nobis-quod',
                            'getAge' => 7,
                            'setAge' => null,
                            'getCreatedAt' => 'porro',
                            'setCreatedAt' => null,
                ...
                0 => [
                    ...
                    'UserAssembler' => [
                        'writeDto' => [
                            ...
                            'getPassword' => 7,
                            'setPassword' => null,
                            'getNickname' => 'http://hyatt.com/',
                            'setNickname' => 'http://wintheiser.com/omnis-qui-eligendi-odio-autem',
                            'getAge' => 7,
                            'setAge' => null,
                            'getCreatedAt' => 'ea',
                            'setCreatedAt' => null,
