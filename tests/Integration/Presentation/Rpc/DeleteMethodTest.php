 ...
 */
class DeleteMethodTest extends AbstractRpcTestCase
{
    /**
     ...
     * @group functional
     *
     * @dataProvider \Backend\Api\User\Tests\DataProvider\RpcMethodDataProvider::getDeleteMethodParams()
     *
    ...
    public function requestToAddMethodShouldReturnTrueInResponse(
        ...
        foreach ($traces as $message) {
            ...
            self::assertEquals(CommandFactory::DELETE_COMMAND, $message['body']['type']);
