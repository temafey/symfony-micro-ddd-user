...
class UserDataProvider
{
    ...
    /**
     * Return valid updated users fixtures.
     *
     * @return mixed[]
     */
    public function getUpdateUsers(): array
    {
        return [
            [
                '08a5481c-5617-40be-a332-80b6be8a33a7',
    ...
    {
        $users = $this->getUsers();
        $updatedUsers = $this->getUpdateUsers();
        $newUsers = [];

        foreach ($users as $i => $user) {
            $newUsers[] = [$user, $updatedUsers[$i]];
        }
